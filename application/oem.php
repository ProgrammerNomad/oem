...
<div class="wrapper">
		  ...
		  <ul class="sidebar-menu" data-widget="tree">	
			  ...
			  <div class="sidebar-widgets">
				...
				<div class="copyright text-center m-25">
					<p><strong class="d-block">vbc Dashboard</strong> © <script>document.write(new Date().getFullYear())</script> All Rights Reserved</p>
				</div>
			  </div>
		  </div>
		</div>
  ...
  <div class="content-wrapper">
    ...
    margin-bottom: 40px;
    font-weight: 600;">Welcome to the OEM Module </h3>
	<h6 style="    font-size: 20px;
    font-weight: 600;">Choose your vbc </h6>
						</div>
						</div>
    ...
    margin-bottom: 30px;">
				...
				<a href="vbc.html" class="waves-effect waves-light nav-link bg-primary btn-primary  fs-14" title="Full Screen">
					Air Sentry
			    </a>
			</div>		
 <div class="col-md-12 as_bb">
...
Copy information to be placed here. Copy information to be placed here.
  ...
  <footer class="main-footer">
	  ...
	  &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">vbc CRM</a>. All Rights Reserved.
  </footer>
  <!-- Side panel --> 
  <!-- quick_panel_toggle -->
