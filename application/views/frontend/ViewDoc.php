...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
  ...
  <div class="wrapper">
    ...
    margin-bottom: 40px;
    font-weight: 600;">Welcome to the Information Module for VBC </h3>
                  ...
                  <div class="row" style="    margin-top: 20px;
                    margin-bottom: 30px;">
                    <div class="col-md-12">
                      <h3><?php echo $DocFiles['0']->title; ?></h3>
                      <p class="doc-decription"><?php echo $DocFiles['0']->description; ?></p>
                    </div>
                    ...
                    <div class="col-md-12">
                      ...
                      foreach (unserialize($DocFiles['0']->picture) as $picture) {


                        echo ' <div class="col-md-4"><a href="/uploads/salesdocs/' . $picture['picture'] . '">
                      <img src="/uploads/salesdocs/' . $picture['picture'] . '"/ class="img-thumbnail"></a></div>';
                      }
                      ?>
                    ...
                    <div class="col-md-12">
                      ...
                      foreach (unserialize($DocFiles['0']->pdf) as $pdf) {


                        echo ' <div class="col-md-4"><a href="/uploads/salesdocs/' . $pdf['pdf'] . '">' . $pdf['pdf'] . '</a></div>';
                      }
                      ?>
                    ...
                    <div class="col-md-12">
                      ...
                      foreach (unserialize($DocFiles['0']->drawing) as $drawing) {


                        echo ' <div class="col-md-4"><a href="/uploads/salesdocs/' . $drawing['drawing'] . '">' . $drawing['drawing'] . '</a></div>';
                      }
                      ?>
                    ...
                    <div class="col-md-12">
                      ...
                      foreach (unserialize($DocFiles['0']->doc_file) as $doc_file) {


                        echo ' <div class="col-md-4"><a href="/uploads/salesdocs/' . $doc_file['doc_file'] . '">' . $doc_file['doc_file'] . '</a></div>';
                      }
                      ?>
                    ...
                    <div class="col-md-12">
                      ...
                      foreach (unserialize($DocFiles['0']->power_point) as $power_point) {


                        echo ' <div class="col-md-4"><a href="/uploads/salesdocs/' . $power_point['power_point'] . '">' . $power_point['power_point'] . '</a></div>';
                      }
                      ?>
                    ...
                    <form class="form">
                      ...
                      <div>
                        ...
                        <div class="form-group mb-0 row align-items-center">
                          ...
                          <div class="col-4 d-flex justify-content-end">
                            <button type="button" class="btn btn-sm btn-toggle btn-primary active"
                      ...
                      <div class="pt-2">
                        ...
                        <div class="form-group mb-0 row align-items-center">
                          ...
                          <div class="col-4 d-flex justify-content-end">
                            <button type="button" class="btn btn-sm btn-toggle btn-danger active"
                              data-bs-toggle="button">
                              <span class="handle"></span>
                            </button>
                          </div>
                      ...
                      <div class="pt-2">
                        ...
                        <div class="form-group mb-0 row align-items-center">
                          ...
                          <div class="col-4 d-flex justify-content-end">
                            <button type="button" class="btn btn-sm btn-toggle btn-warning active"
                              data-bs-toggle="button">
                              <span class="handle"></span>
                            </button>
                          </div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content">
        <div class="ratio ratio-16x9">
          <iframe src="http://player.vimeo.com/video/473177594?title=0&amp;portrait=0&amp;byline=0&amp;autoplay=1"
            ...
            <div class="card no-shadow b-0" style="margin-bottom: 0 !important;">
              <div class="test">
                <div class="card-header d-block">
                  ...
                  <p class="mt-10 ms-0">Sed egestas mauris sit amet orci dignissim, vel pulvinar nisi faucibus. Duis
                    gravida
