...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<div class="col-md-4">
				...
				<a href="#" class="waves-effect waves-light nav-link bg-primary btn-primary  fs-14" title="Full Screen">
					PDF Brochures
			    </a>
			</div>		
 <div class="col-md-12 as_bb">
...
Copy information to be placed here. Copy information to be placed here.
  ...
  <footer class="main-footer">
	  ...
	  &copy; <script>document.write(new Date().getFullYear())</script> <a href="#">CRM</a>. All Rights Reserved.
  </footer>
  <!-- Side panel --> 
  <!-- quick_panel_toggle -->
