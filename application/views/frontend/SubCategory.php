                  ...
                  <div class="row justify-content-between align-items-center">
                    <div class="col-auto">
                      ...
                      <div class="d-inline-block">
                        <a href="#">
                          <img class="img-fluid w-30" src="http://localhost/images/avatar/3.jpg" alt="placeholder image">
                        </a>
                        <a href="#">
                          <img class="img-fluid w-30" src="http://localhost/images/avatar/4.jpg" alt="placeholder image">
                        </a>
                        <a href="#">
                          <img class="img-fluid w-30" src="http://localhost/images/avatar/5.jpg" alt="placeholder image">
                        </a>
                        <a href="#">
                          <img class="img-fluid w-30" src="http://localhost/images/avatar/6.jpg" alt="placeholder image">
                        </a>
                      </div>
                    </div>
                    <div class="col-auto">
