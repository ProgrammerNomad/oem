          ...
          function logout() {
			  ...
			  <div class="sidebar-widgets">
				...
				<div class="copyright m-15">
					<p><strong class="d-block">OEM Dashboard</strong> © <script>document.write(new Date().getFullYear())</script> All Rights Reserved</p>
				</div>
			  </div>
		  </div>
		</div>
...
<div class="col-md-4">
				...
				<a href="oem.html" class="waves-effect waves-light nav-link bg-primary btn-primary  fs-14" title="Full Screen">
					OEM Information
			    </a>
			</div>		
 <div class="col-md-12 as_bb">
