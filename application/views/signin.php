				...
				<div class="row justify-content-center g-0">
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="logo-mini">
				  <span class="light-logo"><img src="images/logo-letter.png" alt="logo" style="    width: 60%;
    margin-bottom: 20px;"></span>
			  </div>
								<h2 class="text-primary">Let's Get Started</h2>
								<p class="mb-0">Sign in to continue to OEM.</p>							
							</div>
							<div class="p-40">
...
<!-- Mirrored from crm-admin-dashboard-template.multipurposethemes.com/crm/vertical/main/auth_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 23 Feb 2024 15:46:34 GMT -->
</html>
