      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            ...
            <form role="form" action="<?php base_url('admin/Controller_Permission/update') ?>" method="post">
              <div class="box-body">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <tr>
                        <td>Good Recipet</td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="createGoodRecipt" <?php if($serialize_permission) {
                          if(in_array('createGoodRecipt', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="updateGoodRecipt" <?php if($serialize_permission) {
                          if(in_array('updateGoodRecipt', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="viewGoodRecipt" <?php if($serialize_permission) {
                          if(in_array('viewGoodRecipt', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                        <td><input type="checkbox" name="permission[]" id="permission" class="minimal" value="deleteGoodRecipt" <?php if($serialize_permission) {
                          if(in_array('deleteGoodRecipt', $serialize_permission)) { echo "checked"; } 
                        } ?>></td>
                      </tr>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('admin/Controller_Permission/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
