                ...
                <div class="form-group">
                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>Good Recipet</td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="createGoodRecipt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="updateGoodRecipt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewGoodRecipt" class="minimal"></td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="deleteGoodRecipt" class="minimal"></td>
                      </tr>
