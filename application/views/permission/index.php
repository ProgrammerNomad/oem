      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createGroup', $user_permission)): ?>
            <a href="<?php echo base_url('admin/Controller_Permission/create') ?>" class="btn btn-primary">Add Permission</a>
            <br /> <br />
          <?php endif; ?>
                    ...
                    <?php foreach ($groups_data as $k => $v): ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?php echo base_url('admin/Controller_Permission/edit/'.$v['id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>  
                          <?php endif; ?>
                          ...
                          <div class="modal fade" id="delete_levels<?php echo $v['id'] ?>" role="dialog">
                            <div class="modal-dialog modal-sm">
                              <div class="modal-content">
                                ...
                                <form action="<?php echo base_url('admin/Controller_Permission/delete/'.$v['id']) ?>" method="post">
