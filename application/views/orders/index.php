    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createOrder', $user_permission)): ?>
          <a href="<?php echo base_url('admin/Controller_Orders/create') ?>" class="btn btn-primary">Add Order</a>
          <br /> <br />
        <?php endif; ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('admin/Controller_Orders/remove') ?>" method="post" id="removeForm">
