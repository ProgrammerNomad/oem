      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createUser', $user_permission)): ?>
            <a href="<?php echo base_url('admin/Controller_Members/create') ?>" class="btn btn-primary">Add New</a>
            <br /> <br />
          <?php endif; ?>
                      ...
                      <tr>
                        ...
                        <td>
                          <?php if(in_array('updateUser', $user_permission)): ?>
                            <a href="<?php echo base_url('admin/Controller_Members/edit/'.$v['user_info']['id']) ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                          <?php endif; ?>
                          <?php if(in_array('deleteUser', $user_permission)): ?>
                            ...
                            <div class="modal-dialog modal-sm">
                              <div class="modal-content">
                                ...
                                <form action="<?php echo base_url('admin/Controller_Members/delete/'.$v['user_info']['id']) ?>" method="post">
