...
class Controller_Orders extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['itmdatarow'] = $this->Admin_model->fetch_data("brands", "*",['id'=>$this->session->userdata('itmid',$itmid),'active'=>1])->row();
	}
			      ...
			      <div class="col-xs-12 table-responsive">
			        <table class="table table-striped table-bordered">
			          ...
			          foreach ($orders_items as $k => $v) {
			          	...
			          	$html .= '<tr>
				            <td>'.$product_data['brandunId'].'</td>
				            <td>'.$product_data['name'].'</td>
				            <td class="fa fa-rupee">'.$v['rate'].'</td>
				            <td>'.$v['qty'].'</td>
				            <td class="fa fa-rupee">'.$v['amount'].'</td>
			          	</tr>';
			          }
			      ...
			      <div class="col-xs-6 pull pull-right">
			        ...
			        <div class="table-responsive">
			          <table class="table table-striped">';
			            ...
			            <tr>
			              <th>Net Amount:</th>
			              <td class="fa fa-rupee">'.$order_data['net_amount'].'</td>
			            </tr>
			            <tr>
			              <th>Bill Status:</th>
			              <td>'.$paid_status.'</td>
